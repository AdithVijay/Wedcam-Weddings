...
const Articles = () => {
  return (
    <div className=' flex flex-col md:flex-row gap-8 '>
        ...
        <div className=' flex flex-col justify-center items-center  '>
            <a href="https://images.app.goo.gl/BYBES5yQKMDuLDKZ7">
                <img className=' h-[480px] w-[330px]' src={art3} alt="" />
            </a>
            <div className='  text-center  text-[#8E8E8E] text-xl w-[80%] pt-2 '>
            സഹതാപം വേണ്ട ! ഇത് നിലാവ് പോലെ ...
             <br />
             <a className=' flex justify-center items-center text-2xl pt-2 ' href="https://images.app.goo.gl/BYBES5yQKMDuLDKZ7">
              Read More 
              </a>
            </div>
        </div>
